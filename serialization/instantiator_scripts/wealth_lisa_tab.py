...
from serialization.instantiator_scripts.LisaWealthParagraph import LisaWealthParagraph
...
def get_lisa_wealth(rinpersoons: list, conn, table_version: str = '', explicit : bool=True, order: int = 0) -> LisaWealthParagraph: ## 20/8
    """
    ...
    for rinpersoon in rinpersoons:
        par_dict[rinpersoon] = [LisaWealthParagraph(
            dataset_name="wealth_lisa_tab",
