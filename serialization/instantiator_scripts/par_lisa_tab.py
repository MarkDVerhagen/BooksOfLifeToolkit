...
from serialization.instantiator_scripts.LisaPartnerParagraph import LisaPartnerParagraph
...
def get_lisa_par(rinpersoons: list, conn, table_version: str = '', explicit : bool=True, order: int = 0) -> LisaPartnerParagraph: ## 20/8
    """
    ...
    for rinpersoon in rinpersoons:
        par_dict[rinpersoon] = [LisaPartnerParagraph(
            dataset_name="par_lisa_tab",
