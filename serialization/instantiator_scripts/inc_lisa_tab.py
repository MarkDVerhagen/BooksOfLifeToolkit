...
from serialization.instantiator_scripts.LisaIncomeParagraph import LisaIncomeParagraph
...
def get_lisa_inc(rinpersoons: list, conn, table_version: str = '', explicit : bool=True, order: int = 0) -> LisaIncomeParagraph: ## 20/8
    """
    ...
    for rinpersoon in rinpersoons:
        par_dict[rinpersoon] = [LisaIncomeParagraph(
            dataset_name="inc_lisa_tab",
