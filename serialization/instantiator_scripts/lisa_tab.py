...
def get_lisa_attributes(rinpersoons: list, conn, table_version: str = '', explicit : bool=True, order: int = 0) -> LisaAttributesParagraph: ## 20/8
    """
    ...
    for rinpersoon in rinpersoons:
        par_dict[rinpersoon] = [LisaAttributesParagraph(
            dataset_name="lisa_tab",
