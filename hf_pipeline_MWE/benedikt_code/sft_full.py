...
# tokenizer = AutoTokenizer.from_pretrained("benediktstroebl/scratch_cooking", token="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")
# model = AutoModelForSequenceClassification.from_pretrained("benediktstroebl/scratch_cooking", token="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", num_labels=2)
# tokenizer = AutoTokenizer.from_pretrained("gpt2")

# add model_name as argparse
...
model_path = args.ft_name

# Load the fine-tuned model and tokenizer
model = AutoModelForSequenceClassification.from_pretrained(model_path, token="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", device_map="auto")
